...
export async function getQueue(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    const statusParam = (req.query.status as string) || "QUEUED";
 ...
 */
export async function deleteQueueItem(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    if (!req.user) {
      res.status(401).json({ success: false, error: "Non authentifié" });
      return;
 ...
 */
export async function retryQueueItem(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    if (!req.user) {
      res.status(401).json({ success: false, error: "Non authentifié" });
      return;
 ...
 */
export async function batchDeleteQueueItems(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    if (!req.user) {
      res.status(401).json({ success: false, error: "Non authentifié" });
      return;
 ...
 */
export async function batchRescheduleQueueItems(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    if (!req.user) {
      res.status(401).json({ success: false, error: "Non authentifié" });
      return;
 ...
 */
export async function getScheduleSettings(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    if (!req.user) {
      res.status(401).json({ success: false, error: "Non authentifié" });
      return;
 ...
 */
export async function updateScheduleSettings(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    if (!req.user) {
      res.status(401).json({ success: false, error: "Non authentifié" });
      return;
