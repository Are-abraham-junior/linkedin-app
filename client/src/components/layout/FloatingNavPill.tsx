...
export const FloatingNavPill: React.FC<FloatingNavPillProps> = ({
  ...
  return (
    <header className="sticky top-4 z-40 px-4 sm:px-8 max-w-7xl mx-auto w-full">
      <div className="adora-nav-pill px-5 py-3 flex items-center justify-between shadow-sm">
        {/* Brand Logo */}
        <div
          className="flex items-center gap-3 cursor-pointer"
          onClick={() => onSelectTab(isSuperAdmin ? "admin-dashboard" : "dashboard")}
        >
          <div className="w-10 h-10 rounded-full bg-[#592eff] flex items-center justify-center text-white shadow-md shadow-[#592eff]/25 transition-transform hover:scale-105">
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
              fill="none"
